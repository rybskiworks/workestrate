...
# via the `microsandbox-fork` flake input at validated rev f8947076 (the brokerd/ssh gateway line atop the nested-virt spec-field rev). The fork is a 0.6.16 workspace
