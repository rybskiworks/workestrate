...
#
# The fork (rev f8947076, pinned via the `microsandbox-fork` flake input —
# the brokerd/ssh gateway line atop the nested-virt spec-field rev) is a 0.6.16 workspace. Vendoring just
