...
fn doctor_check_kvm() -> DoctorCheck {
...
fn doctor_check_tool(name: &'static str, bin: &str, remediation: &str) -> DoctorCheck {
...
fn doctor_check_age_key_file() -> DoctorCheck {
...
fn doctor_check_msb() -> DoctorCheck {
    let bin = msb_binary();
    match probe_version(&bin) {
...
fn doctor_check_home() -> DoctorCheck {
...
fn doctor_check_config_repos() -> Result<DoctorCheck> {
