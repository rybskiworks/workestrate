...
twenty-six Architecture Decision Records (ADRs) that pin every load-bearing
choice.
...
6. `50-decisions/README.md` — ADR index (0001–0026).
7. `50-decisions/NNNN-*.md` — individual ADRs (0001–0026).
