...
| 0028 | Policy scopes: collect-and-compile (never merge) | Accepted | `[policy.mounts]` fragments collected per layer in stack order; a compiler owns precedence/freeze/trust; merge.rs untouched (0020 Ruling 1 unamended); spec 22 primary, spec 01 fallback |
