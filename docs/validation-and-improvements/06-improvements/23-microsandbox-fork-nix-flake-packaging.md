...
- No ADR is created while this design is deferred; ADR 0029 now records
  the policy-scopes decision (renumbered from 0028 during the mount-masking
  merge) and is the next free slot for this design should it earn one.
...
the upstream agentd PR, remains independent. No ADR is created: ADR 0029
(policy-scopes, renumbered from 0028 during the mount-masking merge) is the
next free slot should this design later earn a durable decision.
...
- [ADR 0028](../../migration/50-decisions/0029-policy-scopes-collect-and-compile.md)
...
- [ ] Spec 22, spec 09, ADR 0011, and ADR 0029 (policy-scopes, formerly 0028)
