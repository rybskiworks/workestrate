...
> **Annotated 2026-08-01 (final model):** PARTIALLY SUPERSEDED by [16-unified-secret-env-model.md](16-unified-secret-env-model.md) — the string-array shorthand this spec introduced is replaced by the `true` sugar (`KEY = true` desugars to a host-bound placeholder for secret KEY). The execution history below is kept for the record.
