...
2. **13 — secret_env string-or-table shorthand** (small) — pure config ergonomics; additive serde-only change, `schema_version` stays 1; gates run in-container via `nix develop`.
