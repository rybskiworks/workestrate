...
| [`06-improvements/13-secret-env-shorthand.md`](06-improvements/13-secret-env-shorthand.md) | Config ergonomics: string-or-table shorthand for `secret_env` (additive; `schema_version` stays 1) | `STATUS: EXECUTED (2026-07-31; commits a349d03, 1e7dc25)` — SUPERSEDED 2026-08-01 (v2 model 1ed2e6d removed `secret_env`; shorthand survives only in the v1 shim) |
| [`06-improvements/14-env-map-form.md`](06-improvements/14-env-map-form.md) | Config ergonomics: map form for `env` entries (formatting collapse; additive; `schema_version` stays 1) | `STATUS: EXECUTED (2026-07-31; commits 1035073, 564deca)` — map form became the v2 unified binding map (1ed2e6d) |
...
| [`06-improvements/16-cross-home-dependencies.md`](06-improvements/16-cross-home-dependencies.md) | Cross-home dependencies: wider `workestrate up` across homes/config sets (port-registry blind spot; design space + questions) | `STATUS: INTENT-TO-EXPLORE` |
| [`06-improvements/17-visualization-inspection.md`](06-improvements/17-visualization-inspection.md) | Visualization + inspection surfaces beyond the W3 `workestrate workloads` verb (--json-first, dependency graph, home inspect; data sources) | `STATUS: INTENT-TO-EXPLORE` |
