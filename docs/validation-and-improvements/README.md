...
| [`06-improvements/11-home-provisioning-and-lockfile.md`](06-improvements/11-home-provisioning-and-lockfile.md) | Home provisioning (`home init --from` + positional dest) + generated `workestrate.lock` pin file (executes ADR 0025) | `STATUS: EXECUTED (2026-07-30; commits 172d5dd, 19ff272, be356f7)` |
| [`06-improvements/12-per-instance-addressing.md`](06-improvements/12-per-instance-addressing.md) | Per-instance addressing + discovery-lite (executes ADR 0026; supersedes ADR 0021 §5 `--port-offset`) | `STATUS: IN-PROGRESS (Wave 1 / 12a code landing on migration/tool-model; Experiment E1 + guest-reachability reassessment NEEDS-KVM)` |
