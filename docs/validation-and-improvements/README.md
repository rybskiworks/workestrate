...
| [`06-improvements/13-secret-env-shorthand.md`](06-improvements/13-secret-env-shorthand.md) | Config ergonomics: string-or-table shorthand for `secret_env` (additive; `schema_version` stays 1) | `STATUS: READY-TO-EXECUTE (design; implementation in-container via nix develop, no KVM)` |
