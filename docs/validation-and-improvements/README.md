...
| `06-improvements/17-directory-mode.md` (forthcoming) | Directory-mode config (placeholder — authored by parallel task B) | `STATUS: DESIGN — spec file forthcoming from parallel task B` |
