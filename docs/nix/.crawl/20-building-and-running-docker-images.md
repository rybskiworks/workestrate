...
description: "[Docker](https://www.docker.com/) is a set of tools and services used to build, manage and deploy containers."
resource: https://nix.dev/tutorials/nixos/building-and-running-docker-images.html
tags: [Tutorials, NixOS]
timestamp: 2026-07-24T00:00:00Z
---
> **seed_url**: https://nix.dev/tutorials/nixos/building-and-running-docker-images.html
> **canonical_url**: https://nix.dev/tutorials/nixos/building-and-running-docker-images.html
> **family**: Tutorials
