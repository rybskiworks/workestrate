---
type: Crawl Source
title: "Nix Package Management — Garbage Collection"
description: "Garbage collection in Nix package management."
resource: https://nix.dev/manual/nix/2.34/package-management/garbage-collection
tags: [nix, nix-manual, garbage-collection, package-management]
timestamp: 2026-07-24T00:00:00Z
---

# Crawl: nix-garbage-collection

- seed_url: https://nix.dev/manual/nix/2.34/package-management/garbage-collection
- canonical_url: https://nix.dev/manual/nix/2.34/package-management/garbage-collection
- family: Nix Manual
- fetch: 200
- version: Nix 2.34
- feeds_docs: nix-store-gc.md
