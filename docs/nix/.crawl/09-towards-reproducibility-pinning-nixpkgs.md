---
type: Crawl Source
title: "Towards reproducibility: pinning Nixpkgs"
description: "In various Nix examples, you'll often see the following:."
resource: https://nix.dev/tutorials/first-steps/towards-reproducibility-pinning-nixpkgs.html
tags: [Tutorials, First Steps]
timestamp: 2026-07-24T00:00:00Z
---
> **seed_url**: https://nix.dev/tutorials/first-steps/towards-reproducibility-pinning-nixpkgs.html
> **canonical_url**: https://nix.dev/tutorials/first-steps/towards-reproducibility-pinning-nixpkgs.html
> **family**: Tutorials
