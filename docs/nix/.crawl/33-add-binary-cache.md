...
description: "Nix can be configured to use a binary cache with the."
resource: https://nix.dev/guides/recipes/add-binary-cache.html
tags: [Guides, Recipes]
timestamp: 2026-07-24T00:00:00Z
---
> **seed_url**: https://nix.dev/guides/recipes/add-binary-cache.html
> **canonical_url**: https://nix.dev/guides/recipes/add-binary-cache.html
> **family**: Guides
