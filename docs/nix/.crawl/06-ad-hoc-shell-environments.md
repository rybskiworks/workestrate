---
type: Crawl Source
title: "Ad hoc shell environments"
description: "In a Nix shell environment, you can immediately use any program packaged with Nix, without installing it permanently."
resource: https://nix.dev/tutorials/first-steps/ad-hoc-shell-environments.html
tags: [Tutorials, First Steps]
timestamp: 2026-07-24T00:00:00Z
---
> **seed_url**: https://nix.dev/tutorials/first-steps/ad-hoc-shell-environments.html
> **canonical_url**: https://nix.dev/tutorials/first-steps/ad-hoc-shell-environments.html
> **family**: Tutorials
