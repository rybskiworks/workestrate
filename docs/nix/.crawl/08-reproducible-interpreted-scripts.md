---
type: Crawl Source
title: "Reproducible interpreted scripts"
description: "In this tutorial, you will learn how to use Nix to create and run reproducible interpreted scripts, also known as."
resource: https://nix.dev/tutorials/first-steps/reproducible-scripts.html
tags: [Tutorials, First Steps]
timestamp: 2026-07-24T00:00:00Z
---
> **seed_url**: https://nix.dev/tutorials/first-steps/reproducible-scripts.html
> **canonical_url**: https://nix.dev/tutorials/first-steps/reproducible-scripts.html
> **family**: Tutorials
