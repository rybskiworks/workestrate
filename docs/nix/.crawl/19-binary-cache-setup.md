---
type: Crawl Source
title: "Setting up an HTTP binary cache"
description: "A binary cache stores pre-built [Nix store objects](https://nix.dev/manual/nix/latest/store/store-object) and."
resource: https://nix.dev/tutorials/nixos/binary-cache-setup.html
tags: [Tutorials, NixOS]
timestamp: 2026-07-24T00:00:00Z
---
> **seed_url**: https://nix.dev/tutorials/nixos/binary-cache-setup.html
> **canonical_url**: https://nix.dev/tutorials/nixos/binary-cache-setup.html
> **family**: Tutorials
