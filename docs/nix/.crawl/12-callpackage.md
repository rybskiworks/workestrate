---
type: Crawl Source
title: "Package parameters and overrides with `callPackage`"
description: "Nix ships with a special-purpose programming language for creating packages and configurations: the Nix language."
resource: https://nix.dev/tutorials/callpackage.html
tags: [Tutorials, Packaging]
timestamp: 2026-07-24T00:00:00Z
---
> **seed_url**: https://nix.dev/tutorials/callpackage.html
> **canonical_url**: https://nix.dev/tutorials/callpackage.html
> **family**: Tutorials
