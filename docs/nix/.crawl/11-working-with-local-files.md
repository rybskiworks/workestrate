...
description: "To build a local project in a Nix derivation, source files must be accessible to its [`builder`."
resource: https://nix.dev/tutorials/working-with-local-files.html
tags: [Tutorials, Packaging]
timestamp: 2026-07-24T00:00:00Z
---
> **seed_url**: https://nix.dev/tutorials/working-with-local-files.html
> **canonical_url**: https://nix.dev/tutorials/working-with-local-files.html
> **family**: Tutorials
