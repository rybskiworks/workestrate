---
type: Crawl Source
title: "Declarative shell environments with `shell.nix`"
description: "Declarative shell environments allow you to:."
resource: https://nix.dev/tutorials/first-steps/declarative-shell.html
tags: [Tutorials, First Steps]
timestamp: 2026-07-24T00:00:00Z
---
> **seed_url**: https://nix.dev/tutorials/first-steps/declarative-shell.html
> **canonical_url**: https://nix.dev/tutorials/first-steps/declarative-shell.html
> **family**: Tutorials
