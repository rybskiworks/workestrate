...
description: "[`nixfmt`](https://github.com/NixOS/nixfmt) is the official formatter for {term}`Nix language` code."
resource: https://nix.dev/guides/faq.html
tags: [Guides, FAQ]
timestamp: 2026-07-24T00:00:00Z
---
> **seed_url**: https://nix.dev/guides/faq.html
> **canonical_url**: https://nix.dev/guides/faq.html
> **family**: Guides
