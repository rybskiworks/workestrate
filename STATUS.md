...
|------|---------------|-------|
| workestrate | HEAD on `migration/tool-model` | clean, **17 ahead of origin, NOT pushed**; origin SSH |
...
- Repo state: workestrate now **17 ahead of origin, NOT pushed** (6 new commits: 2593604 + 93df4b0 + 11ec06c + cb793eb + the RUSTFLAGS link-time-rpath fix + this docs entry).
